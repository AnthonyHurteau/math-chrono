...
import { NegativeParamsProps } from "./type";
import YesNoParamComponent from "../YesNoParam";

export default function NegativeParamsComponent(props: NegativeParamsProps) {
  ...
  return (
    <Fragment>
      ...
      <Collapse in={isMobile && params.negativeNumbers} timeout={1000}>
        <Fade in={isMobile && params.negativeNumbers} timeout={1000}>
